...
export function calculateLivePoints(
  ...
  // KO: predicting neither team means no points at all
  if (stage === 'ko' && teamMatchCount === 0) return 0;
  ...
  // KO: B scales by matched team count (1 or 2); D and E are available with any match
